...
import com.zyjr.zyjroa.core.template.config.ContextConfig;
import com.zyjr.zyjroa.core.template.config.SqlConfig;
import com.zyjr.zyjroa.core.template.engine.SimpleTemplateEngine;
import com.zyjr.zyjroa.core.template.engine.base.GunsTemplateEngine;
import com.zyjr.zyjroa.core.util.FileUtil;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void init() {
        ...
        packageConfig.setService("com.zyjr.zyjroa.modular." + contextConfig.getModuleName() + ".service");
        packageConfig.setServiceImpl("com.zyjr.zyjroa.modular." + contextConfig.getModuleName() + ".service.impl");
