...
// 数据库连接
private static final String URL = "jdbc:mysql://192.168.4.157:3306/mytest" + "?user=" + USER + "&password=" + PASS
           + "&useUnicode=true&characterEncoding=UTF-8";
private static final String SAVE_CATALOG = "E:/xxx";
private static final String SAVE_PACKAGE = "com.zyjr.zyjroa.modular.system.controlle";
