...
public class ContextConfig {
    ...
    private String modelPackageName = "com.zyjr.zyjroa.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.zyjr.zyjroa.common.persistence.dao";  //model的dao
