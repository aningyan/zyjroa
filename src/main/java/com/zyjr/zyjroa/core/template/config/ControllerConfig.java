package com.zyjr.zyjroa.core.template.config;
...
public class ControllerConfig {
    ...
    public void init() {
        ...
        imports.add("com.zyjy.zyjroa.core.base.controller.BaseController");
        ...
        imports.add("com.zyjy.zyjroa.core.log.LogObjectHolder");
        imports.add("org.springframework.web.bind.annotation.RequestParam");
        imports.add(contextConfig.getModelPackageName() + "." + contextConfig.getEntityName());
        imports.add("com.zyjy.zyjroa.modular." + contextConfig.getModuleName() + ".service" + ".I" + contextConfig.getEntityName() + "Service");
        this.imports = imports;
        this.packageName = "com.zyjy.zyjroa.modular." + contextConfig.getModuleName() + ".controller";
