...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.zyjy.zyjroa.modular." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        ...
        this.packageName = "com.zyjy.zyjroa.modular." + contextConfig.getModuleName() + ".service";
    }
